...
<section class="mt-8 text-xl px-4">
	<div class="mx-auto">
		...
		<div class="btns mt-5 text-base">
			...
			<a class="btn btn-outline" href="../article/coment?id=${article.id }">댓글등록</a>
		</div>
		...
		<label class="form-control">
			<div class="comment dropdown dropdown-end ">
				...
				<div class="comment">${loginedmember}</div>
			</div>
			<div class="flex-none gap-2 mt-3 ">
				<div class="form-control">
					<textarea placeholder="댓글을 입력해주세요" class="textarea textarea-bordered h-24"></textarea>
				</div>
			</div>
		</label>
		<div class=mt-5>
